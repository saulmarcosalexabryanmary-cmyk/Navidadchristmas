...
var texture1= new THREE.TextureLoader().load("./image/arbol2.jpg");
...
//scene.add(mesh02);
mesh02.position.set(5,8,-3);

var navidad = new THREE.Group();
navidad.add(mesh01,mesh02);
navidad.position.set(x,y,z);
